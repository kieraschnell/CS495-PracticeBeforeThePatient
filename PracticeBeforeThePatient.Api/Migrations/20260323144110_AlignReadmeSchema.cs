...
{
    /// <inheritdoc />
    public partial class AlignReadmeSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SsoSubject = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_ClassId_ScenarioId",
                table: "Assignments",
                columns: new[] { "ClassId", "ScenarioId" });
